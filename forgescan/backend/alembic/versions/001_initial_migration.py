...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('plan', sa.String(50), default='free', nullable=False, index=True),
        sa.Column('max_scans', sa.Integer, default=5),
    ...
    op.create_table(
        ...
        sa.Column('findings_summary', postgresql.JSON, default={}),
